...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | MyWisata</title>
...
<body>
    <div class="error-page">
        <div class="text-center">
            ...
            <h2 class="error-text mb-3">Halaman Tidak Ditemukan</h2>
            <p class="error-text mb-4">Maaf, halaman yang Anda cari tidak tersedia.</p>
