    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card mb-4">
                ...
                <?php else: ?>
                    <img src="http://localhost/mywisata/public/assets/img/placeholder_large.png" class="card-img-top" alt="<?= View::e($restaurant['name']) ?>" style="height: 400px; object-fit: cover;">
                <?php endif; ?>
                <div class="card-body">
