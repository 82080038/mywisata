    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card mb-4">
                ...
                <?php else: ?>
                    <div class="card-img-top bg-info d-flex align-items-center justify-content-center" style="height: 400px;">
                        <i class="fas fa-hotel text-white" style="font-size: 4rem;"></i>
                    </div>
                <?php endif; ?>
                <div class="card-body">
